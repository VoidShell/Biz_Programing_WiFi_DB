...
public class k27_CreateTable {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        k27_stmt.execute("create table examtable(" + //Result Set이 의미 없음 executeQuery -> execute
                "k27_name varchar(20) ," +
                "k27_studentid int not null primary key, " +
                "k27_kor    int, " +
                "k27_eng    int, " +
                "k27_mat    int)" +
                "DEFAULT CHARSET=utf8; ");
        // excute 안에 테이블 생성 쿼리를 입력한다. studentid를 primary key로 지정한다.
